...
- 그리고 수평선 너머, 안개 속 도시의 실루엣 —

## 스토리: 「도시 편」

배달을 돕다 보면 어느 날 도시에서 초대장이 온다. 빌딩 협곡과 네온, 전차,
마을의 두 배인 보수 — 처음엔 모든 게 반짝인다. 그런데 도시의 밤엔 별이 없고,
바람 소리 대신 낮은 소음이 깔리고, 지지가 점점 말이 없어진다.
프롤로그부터 에필로그까지, 막이 바뀔 때마다 영화식 타이틀 카드가 뜬다.
퀘스트 목록 대신 **소녀의 일기**(`I`)가 오늘의 목표를 적어두고,
중요한 순간엔 화면 아래 대화창에 소녀와 지지의 대화가 흐른다.
어떻게 끝나는지는… 직접 돌아와 보자.
